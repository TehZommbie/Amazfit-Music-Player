...
public class WidgetSettings {
    ...
    private String getString(String key, String defvalue) {
        ...
        try {
            ...
            value = defvalue;
            Log.e(Constants.TAG, "WidgetSettings getString exception: " + e.toString());
        }
        return value;
    }
    ...
    private int getInt(String key, int defvalue) {
        ...
        try {
            ...
            value = defvalue;
            Log.e(Constants.TAG, "WidgetSettings getInt exception: " + e.toString());
        }
        return value;
    }
    ...
    private boolean getBoolean(String key, boolean defvalue) {
        ...
        try {
            ...
            value = defvalue;
            Log.e(Constants.TAG, "WidgetSettings getBoolean exception: " + e.toString());
        }
        return value;
    }
    ...
    private long getLong(String key, long defvalue) {
        ...
        try {
            ...
            value = defvalue;
            Log.e(Constants.TAG, "WidgetSettings getLong exception: " + e.toString());
        }
        return value;
    }
    ...
    private boolean setString(String key, String value) {
        ...
        try {
            ...
            Log.e(Constants.TAG, "WidgetSettings setString exception: " + e.toString());
        }
    ...
    private boolean setInt(String key, int value) {
        ...
        try {
            ...
            Log.e(Constants.TAG, "WidgetSettings setInt exception: " + e.toString());
        }
    ...
    private boolean setBoolean(String key, boolean value) {
        ...
        try {
            ...
            Log.e(Constants.TAG, "WidgetSettings setBoolean exception: " + e.toString());
        }
    ...
    private boolean setLong(String key, long value) {
        ...
        try {
            ...
            Log.e(Constants.TAG, "WidgetSettings setLong exception: " + e.toString());
        }
